...
export const tutorials = [
    '1. Grant camera permission to the app to enable pose capture.',
    '2. Choose your desired pose from the dropdown menu.',
    '3. Review the instructions for the selected pose to understand the correct execution.',
    '4. Initiate the pose by clicking "Start," and observe the corresponding image on the right side. Replicate this pose in front of the camera.',
    '5. Achieve accuracy to turn the skeleton in the video green, accompanied by the start of sound playback.'
]

export const fixCamera = [
    'Solution 1: Ensure that camera permissions are granted. If permission has been denied, navigate to your browser settings and authorize camera access for the application.',
    'Solution 2: Verify that no other applications are currently utilizing the camera. If another application is active, close it.',
    'Solution 3: Close all other open browsers to optimize camera functionality.'
] 
